...
async function requireAuth(req, res, next) {
  ...
  const [rows] = await pool.query('SELECT id, name, phone, email, email_verified_at, phone_verified_at, pin_hash, pin_salt, disabled_at, account_type FROM users WHERE token = ?', [token]);
