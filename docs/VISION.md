...
| **CitaApp** (`citaapp.net`) | SaaS de agenda dominicano | **Ya tiene calendario con disponibilidad real** funcionando (~30 negocios RD, sobre todo barbería/uñas); US$5–15/mes | No es marketplace de descubrimiento — el cliente llega porque el negocio comparte su link, no hay "buscar cerca de mí" |
| **Te Resuelvo** (`teresuelvo.com` + app) | Marketplace generalista dominicano (eventos, belleza, hogar…) | Verificación de identidad, reseñas, chat directo | Muy temprano (2 reseñas en App Store); sin calendario de reservas, coordina por chat |
