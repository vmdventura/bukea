...
| `/precios` | Precios | `/pricing` | Planes en RD$, qué incluye, WhatsApp, "sin comisión por cliente nuevo", prueba gratis | P1 (texto decidido por Víctor tras §3.2) |
